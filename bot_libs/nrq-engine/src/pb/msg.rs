...
pub struct RoutingHead {
    ...
    #[prost(message, optional, tag="2")]
    pub grp: ::core::option::Option<Grp>,
    #[prost(message, optional, tag="3")]
    pub grp_tmp: ::core::option::Option<GrpTmp>,
    ///
    ///Dis dis = 4;
    ///DisTmp disTmp = 5;
    ...
    ///CommTmp? commTmp = 22;
    #[prost(message, optional, tag="6")]
    pub wpa_tmp: ::core::option::Option<WpaTmp>,
}
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct WpaTmp {
    #[prost(uint64, optional, tag="1")]
...
pub struct NotOnlineImage {
    ...
    #[prost(int32, optional, tag="8")]
    pub pic_height: ::core::option::Option<i32>,
    #[prost(int32, optional, tag="9")]
    pub pic_width: ::core::option::Option<i32>,
