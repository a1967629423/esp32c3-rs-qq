...
impl Poller {
    ...
    pub fn delete(&self, sock: RawSocket) -> io::Result<()> {
        log::info!("remove: handle={:?}, sock={}", self.handle, sock);
    ...
    pub fn wait(&self, events: &mut Events, timeout: Option<Duration>) -> io::Result<()> {
        log::info!("wait: handle={:?}, timeout={:?}", self.handle, timeout);
        ...
        loop {
            ...
            log::info!("new events: handle={:?}, len={}", self.handle, events.len);
    ...
    pub fn notify(&self) -> io::Result<()> {
        log::info!("notify: handle={:?}", self.handle);
...
impl Drop for Poller {
    fn drop(&mut self) {
        log::info!("drop: handle={:?}", self.handle);
        unsafe {
